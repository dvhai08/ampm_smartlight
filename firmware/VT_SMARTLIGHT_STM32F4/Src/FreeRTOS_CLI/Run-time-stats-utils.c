...
int QueryPerformanceFrequency(unsigned long long *value  ) 
{
	*value = 1000000;
	return 1;
}
int QueryPerformanceCounter(unsigned long long *value  )
{
	long long temp;
	*value = 1000000;
	*value = HAL_GetTick();
...
{
	unsigned long long liPerformanceCounterFrequency, liInitialRunTimeValue;
	...
	else
	{
		...
		millisecond. */
		llTicksPerHundedthMillisecond = liPerformanceCounterFrequency / 100000LL;
		...
		llInitialRunTimeCounterValue = liInitialRunTimeValue;
	}
}
/*-----------------------------------------------------------*/
...
{
unsigned long long liCurrentCount;
unsigned long ulReturn = 0;
	...
	{
		ulReturn = ( unsigned long ) ( ( liCurrentCount - llInitialRunTimeCounterValue ) / llTicksPerHundedthMillisecond );
	}
