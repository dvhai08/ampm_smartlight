...
/**
 * @brief add a object for json format
 *
 * This function will add the object for a json documentation
 *
 *
 * @param pJsonDocument buffer to be updated with the client token string
 * @param maxSizeOfJsonDocument maximum size of the pBufferToBeUpdatedWithClientToken that can be used
 * @param jsonObj a given Object
 * @param count total number of arguments(jsonStruct_t object) passed in the arguments
 * @return An IoT Error Type defining if the buffer was null or the entire string was not filled up
 */
...
/**
 * @brief add number of field for json format
 *
 * This function will add the object for a json documentation
 *
 *
...
IoT_Error_t aws_iot_shadow_add_fields(char *pJsonDocument, size_t maxSizeOfJsonDocument,
																			uint8_t count , ...);
/**
 * @brief add a header reported for json format
 *
 * This function will add the header reported for a json documentation
 *
 *
 * @param pJsonDocument buffer to be updated with the client token string
 * @param maxSizeOfJsonDocument maximum size of the pBufferToBeUpdatedWithClientToken that can be used
...
/**
 * @brief add a footer reported for json format
 *
 * This function will add a footer reported for a json documentation
 *
 *
 * @param pJsonDocument buffer to be updated with the client token string
 * @param maxSizeOfJsonDocument maximum size of the pBufferToBeUpdatedWithClientToken that can be used
