 ...
 * @brief TimerAWS interface definition for MQTT client.
 *
...
/**
 * The platform specific timer header that defines the TimerAWS struct
 */
 ...
 *
 */
//typedef struct TimerAWS TimerAWS;
 ...
 *
 * @param TimerAWS - pointer to the timer to be checked for expiration
 ...
 *
 * @param TimerAWS - pointer to the timer to be set to expire in milliseconds
 ...
 *
 * @param TimerAWS - pointer to the timer to be set to expire in seconds
 ...
 *
 * @param TimerAWS - pointer to the timer to be set to checked
 ...
 *
 * @param TimerAWS - pointer to the timer to be initialized
 */
