...
#define FLASH_START_ADDR	(1*1024*1024)


#define LOG_SIZE_MAX	(40*1024)
#define FIRMWARE_MAX_SIZE		0x00080000 //512k

#define FIRMWARE_INFO_ADDR 								0
#define FIRMWARE_BASE_ADDR								(0x00001000 + FIRMWARE_INFO_ADDR)

#define DEVICE_PARAMETER_ADDR		(FIRMWARE_BASE_ADDR + FIRMWARE_MAX_SIZE)
#define DEVICE_IO_STATUS_ADDR		(DEVICE_PARAMETER_ADDR + SST25_SECTOR_SIZE)
#define PARAMETER_BASE_ADDR		(DEVICE_PARAMETER_ADDR + SST25_SECTOR_SIZE)
...
#define OVER_DRIVING_TIME_START											8
#define OVER_DRIVING_LAT_START											9
#define OVER_DRIVING_LON_START											10
#define OVER_SPEED_TIME_START												11
#define OVER_SPEED_LAT_START												12
#define OVER_SPEED_LON_START												13
#define PARKING_TIME_SAVE_ADDR											14
#define TOTAL_DRIVING_TIME_SAVE_ADDR								15
#define GPS_HDOP_SAVE_ADDR													16
#define GPS_DIR_SAVE_ADDR														17
#define TIME_SAVE_ADDR															18
#define SYSTEM_TIME_SAVE_ADDR												19
#define DRIVER_INDEX_ADDR														20		
#define SYS_STATUS_ADDR															21
#define CRC_ALL_DATA_ADDR														22
#else
...
#define SYSTEM_TIME_SAVE_ADDR												(0x0000D000 + PARAMETER_BASE_ADDR)
#define DRIVER_INDEX_ADDR														(0x0000E000 + PARAMETER_BASE_ADDR)
#define SYS_STATUS_ADDR															(0x0000F000 + PARAMETER_BASE_ADDR)
#define OVER_DRIVING_TIME_START											(0x00010000 + PARAMETER_BASE_ADDR)
#define OVER_DRIVING_LAT_START											(0x00011000 + PARAMETER_BASE_ADDR)
#define OVER_DRIVING_LON_START											(0x00012000 + PARAMETER_BASE_ADDR)
#define OVER_SPEED_TIME_START												(0x00013000 + PARAMETER_BASE_ADDR)
#define OVER_SPEED_LAT_START												(0x00014000 + PARAMETER_BASE_ADDR)
#define OVER_SPEED_LON_START												(0x00015000 + PARAMETER_BASE_ADDR)
#define CRC_ALL_DATA_ADDR														(0x00016000 + PARAMETER_BASE_ADDR)
...
#define SST25_MSC_FLASH_START	0x00000000
...
uint8_t OS_SST25_Erase(uint32_t addr, enum SST25_ERASE_MODE mode);
uint8_t OS_SST25_Read(uint32_t addr, uint8_t *buf, uint32_t count);
uint8_t OS_SST25_Write(uint32_t addr, const uint8_t *buf, uint32_t count);
uint8_t OS_SST25_WriteNoErase(uint32_t addr, const uint8_t *buf, uint32_t count);
