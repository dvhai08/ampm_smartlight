 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT2_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(2))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT3_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(3))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT4_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(4))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT5_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(5))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT6_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(6))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
 ...
 * @showinitializer
 *****************************************************************************/
#define PORT_MODULE_ALT7_PULLUP_ON_MODE                                       \
(tPORT){                                                                      \
/* PCR  */ SET(PORT_PCR_IRQC(0))|CLR(PORT_PCR_LK_MASK)|SET(PORT_PCR_MUX(7))|  \
/* ...  */ CLR(PORT_PCR_SRE_MASK)|SET(PORT_PCR_PE_MASK)|                      \
/* ...  */ SET(PORT_PCR_PS_MASK),                                             \
...
{ 
  ...
  PORTC_CALLBACK =   4, ///< PORTC interrupt
  PORTD_CALLBACK =   8, ///< PORTD interrupt
  PORTE_CALLBACK =  16, ///< PORTE interrupt
  PORTF_CALLBACK =  32, ///< PORTF interrupt
  PORTG_CALLBACK =  64, ///< PORTG interrupt
  PORTH_CALLBACK = 128, ///< PORTH interrupt
  PORTI_CALLBACK = 256  ///< PORTI interrupt
} PORT_CALLBACK_SRC;
