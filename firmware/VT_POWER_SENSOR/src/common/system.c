 ...
 ****************************************************************************/
  ...
  #elif defined(__CC_ARM)    
    void (* const __memcfg_table[])() __attribute__ ((section(".ARM.__at_0x400"),used)) = 
#endif
{    
   CONFIG_1,
   CONFIG_2,
 ...
 ****************************************************************************/
    ...
    #elif defined(__CC_ARM)
      unsigned char __mtb_ram[MTB_RAM_SIZE] __attribute__((section (".ARM.__at_0x1ffff000"),used, zero_init));
  #endif
#endif   
