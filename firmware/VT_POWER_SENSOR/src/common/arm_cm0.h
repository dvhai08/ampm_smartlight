...
/***************************************************************************//*!
 * @brief   Get identifier passed by Supervisor Call (SVC).
...
/***************************************************************************//*!
 * @brief   Set top of Process Stack Pointer (PSP). 
...
/***************************************************************************//*!
 * @brief   Set top of Main Stack Pointer (MSP). 
 * @details This macro sets top of Main Stack Pointer (MSP).
 * @param   value value 32-bit value of the top of Main Stack Pointer.
 * @note    Implemented as an inline function.
 * @see     @ref UserMode, @ref SpvrMode, @ref SVC_Call, @ref SVC_GetId, 
