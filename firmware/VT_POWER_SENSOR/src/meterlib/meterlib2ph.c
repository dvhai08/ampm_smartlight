 ...
 ******************************************************************************/
static inline int CalcEnergy (tENERGY_DATA *p, Frac24 u1, Frac24 i1, Frac24 u2, 
                               Frac24 i2, Frac32 *pCnt, Frac64 outRes)
{
  register Frac64 energy, tmp, val;

  /* smooth energy measurements                                               */
  energy = LL_add(LL_iir_1ord(LL_mac_ll(LL_mul_ll(i1,u1),i2,u2),&p->xIIR,&p->yIIR,
                              p->cofIIR),(p->offset<<1));
 ...
 *
 ****************************************************************************/  
void METERLIB2PH_RemoveDcBias (tMETERLIB2PH_DATA *p, Frac24 u1Q, Frac24 i1Q, 
 ...
 *
 ****************************************************************************/  
int METERLIB2PH_CalcWattHours (tMETERLIB2PH_DATA *p, Frac32 *pCnt, Frac64 outRes)
{   
  ...
  return CalcEnergy (&p->Wh, tmp32_1, tmp32_2, tmp32_3, tmp32_4, pCnt, outRes);  
}
 ...
 *
 ****************************************************************************/  
int METERLIB2PH_CalcVarHours (tMETERLIB2PH_DATA *p, Frac32 *pCnt, Frac64 outRes)
{
  register Frac32 tmp32_1, tmp32_2, tmp32_3, tmp32_4;
 ...
 *
 ****************************************************************************/
void METERLIB2PH_ReadResultsPh1 (tMETERLIB2PH_DATA *p, double *urms, double *irms, 
 ...
 *
 ****************************************************************************/
void METERLIB2PH_ReadResultsPh2 (tMETERLIB2PH_DATA *p, double *urms, double *irms, 
                           double *w, double *var, double *va, double *umax, 
                           double *imax)
{ 
  register Frac32 tmp_1, tmp_2, tmp_3, tmp_4;
